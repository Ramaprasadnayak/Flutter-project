  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  Stack(
        ...
        ListView(
        children: [
          StoryCard1(title: 'Zara and the Rainbow Tree', moral: 'Kindness lights the way to magical things.'),
          StoryCard2(title: 'Gandhi and the Goat', moral: 'Truth always wins'),
        ],
      ),
        ]
      )
