        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child:Center(
                child:  Text("What did Zara wish for at the Rainbow Tree?",style: TextStyle(color: const Color.fromARGB(255, 33, 29, 29)))
              )
            ),
            Row(
              children: [
                ...
                SizedBox(
                  ...
                  child: RadioMenuButton(
                    ...
                    child: Text("A. A pet unicorn",style: TextStyle(color: Color.fromARGB(255, 33, 29, 29)),)
                    )
                  ),
                  ...
                  child: RadioMenuButton(
                    ...
                    child: Text("B.More sandwich",style: TextStyle(color: Color.fromARGB(255, 33, 29, 29)),)
                    )
                  ),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: RadioMenuButton(
                    ...
                    child: Text("C. A magic book",style: TextStyle(color: Color.fromARGB(255, 33, 29, 29)))
                    ),
                  ),
                  ...
                  height: 50,
                  child: RadioMenuButton(
                    value: "Happiness_for_all_children",
                    groupValue: selected, 
                    onChanged: showradio?
                    (selectedvalue){
                      setState(() {
                    ...
                    child: Text("D.Happiness",style: TextStyle(color: Color.fromARGB(255, 33, 29, 29)),)
                    )
                  )
              ]
            ),
            ...
            ElevatedButton(onPressed: (){
              setState(() {
                ...
                if(selected=="Happiness_for_all_children"){
                  bcolor4=Colors.green;
                  shownext=true;
                }
                else if(selected=="A_pet_unicorn"){
                  bcolor1=const Color.fromARGB(255, 198, 43, 31);
                  shownext=false;
                }
                else if(selected=="More_sandwiches"){
                  bcolor2= const Color.fromARGB(255, 198, 43, 31);
                  shownext=false;
                }
                else if(selected=="A_magic_book"){
