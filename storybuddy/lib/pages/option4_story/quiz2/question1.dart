...
import 'package:storybuddy/pages/option4_story/quiz2/question2.dart';
...
class Quesion1 extends State<Quiz4>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Question 1 :",style: TextStyle(color: Color.fromARGB(255, 32, 29, 29)),),backgroundColor:Color.fromARGB(255, 207, 107, 197)),
      body: Center(
        child: Column(
          children: [
            SizedBox(height: 150),
            ...
            Container(
              ...
              child:Center(
                child: Text("What did Riya admire about Pandit Nehru?",style: TextStyle(color: const Color.fromARGB(255, 33, 29, 29)))
              )
            ),
            Row(
              children: [
                ...
                SizedBox(
                  ...
                  child: RadioMenuButton(
                    ...
                    child: Text("A. His car",style: TextStyle(color: Color.fromARGB(255, 33, 29, 29)),)
                    )
                  ),
                  ...
                  child: RadioMenuButton(
                    ...
                    child: Text("B.His speeches",style: TextStyle(color: Color.fromARGB(255, 33, 29, 29)),)
                    )
                  ),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: RadioMenuButton(
                    ...
                    child: Text("C.rose he wore",style: TextStyle(color: Color.fromARGB(255, 33, 29, 29)))
                    ),
                  ),
                  ...
                  child: RadioMenuButton(
                    ...
                    child: Text("D. His books",style: TextStyle(color: Color.fromARGB(255, 33, 29, 29)),)
                    )
                  )
              ]
            ),
            ...
            ElevatedButton(onPressed: (){
              setState(() {
                ...
                if(selected=="The_rose_he_wore"){
                  bcolor3=Colors.green;
                  shownext=true;
                }
                else if(selected=="His_car"){
                  bcolor1=const Color.fromARGB(255, 198, 43, 31);
                  shownext=false;
                }
                else if(selected=="His_speeches"){
                  bcolor2= const Color.fromARGB(255, 198, 43, 31);
                  shownext=false;
                }
                else if(selected=="His_books"){
